...
/**
 * @brief 串口绘图初始化. 优化方案：UART_HandleTypeDef *huart 改成 UART_Manage_Object *UART_Manage_Object，下面的if逻辑也进行改动
 *
...
/**
 * @brief 添加被发送的数据.  优化方案：将Set_Data与TIM_Write_PeriodElapsedCallback整合为一个API接口
 *
